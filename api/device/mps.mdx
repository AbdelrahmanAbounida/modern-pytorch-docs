...
<Card title="Official PyTorch Documentation" icon="book" href="https://pytorch.org/docs/stable/mps.html">
  View the complete official documentation for MPS
</Card>

## Quick Links

<CardGroup cols={2}>
  <Card title="API Reference" icon="code" href="https://pytorch.org/docs/stable/mps.html">
    Detailed API documentation
  </Card>
  <Card title="Examples" icon="lightbulb" href="https://pytorch.org/docs/stable/mps.html#examples">
...
- [Official PyTorch Docs](https://pytorch.org/docs/stable/mps.html)
...
<Note>
  This documentation is supplementary to the [official PyTorch documentation](https://pytorch.org/docs/stable/mps.html). 
