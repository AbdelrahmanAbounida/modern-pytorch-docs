...
<Card title="Official PyTorch Documentation" icon="book" href="https://pytorch.org/docs/stable/xpu.html">
  View the complete official documentation for XPU
</Card>

## Quick Links

<CardGroup cols={2}>
  <Card title="API Reference" icon="code" href="https://pytorch.org/docs/stable/xpu.html">
    Detailed API documentation
  </Card>
  <Card title="Examples" icon="lightbulb" href="https://pytorch.org/docs/stable/xpu.html#examples">
...
- [Official PyTorch Docs](https://pytorch.org/docs/stable/xpu.html)
...
<Note>
  This documentation is supplementary to the [official PyTorch documentation](https://pytorch.org/docs/stable/xpu.html). 
